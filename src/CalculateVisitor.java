...
//This class implements the Visitor interface and provides a pop up window for each visit method
public class CalculateVisitor implements Visitor 
{
    ...
    public void visitUserTotal(UserTotal userTotal) 
	{
        ...
        JLabel label = new JLabel("Total Users in System: " + userTotal.getUserTotal());
    ...
    public void visitGroupTotal(GroupTotal groupTotal) 
	{
        ...
        JLabel label = new JLabel("Total Groups in System: " + groupTotal.getGroupTotal());
    ...
    public void visitMessageTotal(MessageTotal messageTotal) 
	{
        ...
        JLabel label = new JLabel("Total Tweets in System: " + messageTotal.getMessageTotal());
    ...
    public void visitPositiveMessages(PositiveMessages positiveMessages) 
	{
        ...
        JLabel label = new JLabel("Total Percentage of Positive Tweets: " + ((positiveMessages.getPositiveMessages()) * 100) + "%" );
